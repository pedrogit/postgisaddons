...
DROP AGGREGATE ST_AreaWeightedSummaryStats(geomval);
DROP AGGREGATE ST_AreaWeightedSummaryStats(geometry, double precision);
DROP AGGREGATE ST_AreaWeightedSummaryStats(geometry);
