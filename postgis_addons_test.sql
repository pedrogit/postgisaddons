...
WITH test_nb AS (
    ...
    SELECT 'ST_RemoveOverlaps'::text,            20,         12
),
test_series AS (
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, 'NO_MERGE') geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, 'OVERLAPS_ONLY') geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, 'OVERLAPS_ONLY_DUP') geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, id) geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, id, 'LARGEST_AREA') geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, id, 'LARGEST_VALUE') geom
    FROM test_topology
)
...
UNION ALL (
WITH newpolys AS (
    SELECT ST_RemoveOverlaps(geom, id, 'SMALLEST_VALUE') geom
    FROM test_topology
)
